...
public class OTPActivity extends AppCompatActivity {
    ...
    public String phoneNumber, Fname, visitorId;
            ...
            public void onClick(View v) {
                ...
                if(Enterotp.equals(VerificationId)) {
                    ...
                    if (userPhone.equals(phoneNumber)) {
                        editor.putInt("Existing", 0);
                        editor.putString("FirstName", Fname);
                        editor.putString("VisitorId", visitorId);
                        editor.putString("Purpose", "");
                        editor.putString("MeetWhom", "");
                        editor.apply();

                        Intent preview = new Intent(OTPActivity.this, CameraActivity.class);
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                try {
                    ...
                    for (int i = 0; i < dataArray.length(); i++) {
                        ...
                        Fname = dataobj.getString("FirstName");
                        visitorId = dataobj.getString("id");
